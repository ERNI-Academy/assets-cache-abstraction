...
public class OnMemoryCacheManagerTests : IClassFixture<TestFixture>
{ 
    private readonly TestFixture _fixture;

    public OnMemoryCacheManagerTests(TestFixture fixture)
    {
        _fixture = fixture;
        _fixture.Initialize((s, c) => { s.AddCacheOnMemory(); });
    }
